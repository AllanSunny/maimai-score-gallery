      ...
      <span className="relative block">
        ...
        <input
          ...
          className={classNames(
            "w-full appearance-none rounded-xl border border-line bg-white/95 py-0 h-9.5 sm:h-10.5 pl-11 text-base leading-5 text-dark outline-none transition placeholder:text-darker/60 focus:border-dark focus:ring-3 focus:ring-dark/10 [&::-webkit-search-cancel-button]:appearance-none",
