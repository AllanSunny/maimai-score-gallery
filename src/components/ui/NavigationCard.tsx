...
export function NavigationCard({ href, title, description }: NavigationCardProps) {
  return (
    <a
      href={href}
      className="group flex min-h-48 flex-col justify-between rounded-2xl border border-line bg-white/50 p-6 no-underline transition hover:-translate-y-0.5 hover:border-muted/50 hover:bg-white"
    >
      <div>
