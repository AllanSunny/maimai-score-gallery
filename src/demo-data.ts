...
export const demoScores: Score[] = [
  {
    ...
    difficulty: "EXPERT", level: "13+", chartConstant: 13.8, achievement: 100.5079, combo: "FC",
  ...
  },
  {
    ...
    difficulty: "MASTER", level: "13", chartConstant: 13.4, achievement: 99.9821, combo: "FC+",
  ...
  },
  {
    ...
    difficulty: "Re:MASTER", level: "14+", chartConstant: 14.7, achievement: 98.7432, combo: "Clear",
